                ...
                <div class="container-fluid">
                    ...
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">Edit Message</h1>
                        </div>
                        <?php
                        if (isset($_GET['ids'])) :
                            $userId = $_GET['ids'];
                            ...
                            while ($row = mysqli_fetch_array(($userRecord))) :
                                $id = $row['id'];
                                $message = $row['message'];
                                $date = $row['date_announce'];
                                $status = $row['msg_status'];
                        ?>
                                <form class="user" method="POST" action="script/editmsgscript.php">
                                    <input type="hidden" name="id" value="<?php echo $id ?>">
                                    <div class="form-group">
                                        <textarea name="message" id="" cols="30" rows="5" class="form-control"><?php echo $message ?>
                                </textarea>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <select name="status" id="" class="form-control">
                                            ...
                                            <option value="0" <?php if ($status == "0") echo "selected"; ?>>0 - Hidden</option>
                                            <option value="1" <?php if ($status == "1") echo "selected"; ?>>1 - Visible</option>
                                        </select>
                                    </div>

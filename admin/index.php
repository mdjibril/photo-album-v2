                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Males</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $males['0'] ?></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            ?>
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Females
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?php echo $females['0'] ?></div>
                                                </div>
                                                <!-- <div class="col">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            $sqlactive = "SELECT COUNT(is_active) FROM `user` WHERE `is_active` = 1";
                                            $allactive = mysqli_query($conn, $sqlactive);
                                            $activated =  mysqli_fetch_row($allactive);

                                            ?>
                                            <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                Activated</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $activated['0'] ?></div>
                                        </div>
                                        <div class="col-auto">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            $sqldeactive = "SELECT COUNT(is_active) FROM `user` WHERE `is_active` = 0";
                                            $alldeactive = mysqli_query($conn, $sqldeactive);
                                            $deactivated =  mysqli_fetch_row($alldeactive);

                                            ?>
                                            <div class="text-xs font-weight-bold text-danger text-uppercase mb-1">
                                                Dactivated</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $deactivated['0'] ?></div>
                                        </div>
                                        <div class="col-auto">
